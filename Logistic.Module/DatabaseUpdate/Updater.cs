...
namespace Logistic.Module.DatabaseUpdate {
    ...
    public class Updater : ModuleUpdater {
        ...
        public override void UpdateDatabaseAfterUpdateSchema() {
			...
			userAdmin.Roles.Add(adminRole);
                if (ObjectSpace.GetObjectsCount(typeof(AboutCompanySingleton), null) == 0) ObjectSpace.CreateObject<AboutCompanySingleton>();
