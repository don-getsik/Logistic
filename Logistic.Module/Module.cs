...
namespace Logistic.Module {
    // For more typical usage scenarios, be sure to check out https://documentation.devexpress.com/eXpressAppFramework/clsDevExpressExpressAppModuleBasetopic.aspx.
    public sealed partial class LogisticModule : ModuleBase {
        static LogisticModule() {
            ...
            #if DEBUG
            Database.SetInitializer(new DropCreateDatabaseIfModelChanges<LogisticDbContext>());
            #endif 
        }
